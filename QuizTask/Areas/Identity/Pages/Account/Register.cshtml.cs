...
namespace QuizTask.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(int User_Reg_No,string User_Name,string Role,string Mobile_No,bool User_Status, AdminUser adminUser ,string returnUrl = null)
        {
            returnUrl ??= Url.Content("~/");
            ExternalLogins = (await _signInManager.GetExternalAuthenticationSchemesAsync()).ToList();
            adminUser.User_Reg_No = User_Reg_No;
            adminUser.User_Name = User_Name;
            adminUser.User_Email = Input.Email;
            adminUser.User_Passward = Input.Password;
            adminUser.Role = Role;
            adminUser.Mobile_No = Mobile_No;
            adminUser.User_Status = User_Status;
